...
public class Activity_E extends BaseActivity {
    ...
    private static final String TAG= Activity_E.class.getSimpleName();
    ...
    private void updateText() {
        textViewInstanceValue.setText("APP 2 Activity E, id: " + currentInstanceValue);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.buttonStartActivityD: startActivity(this, Activity_E.class);break;
            case R.id.buttonStartActivityE:
            {
//                Intent e = new Intent(this,Activity_E.class);
//                e.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//                startActivity(e);
                Intent i = new Intent("com.evs.android.test.ANOTHER_ACTIVITY");
                startActivity(i);
                break;
            }
            default:break;
